...
*/
    ...
    @Override
    public List<Message> getMessagesbyId(String idO, String idT) throws SQLException{
        return session.findAll(Message.class, Map.of("idOrigin", idO,"idTarget",idT));
    }

    @Override
    public List<Message> getAllMessages() throws SQLException{
        return session.findAll(Message.class);
    }
